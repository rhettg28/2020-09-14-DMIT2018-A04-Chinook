...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowPaging="True" PagerSettings-Mode="NumericFirstLast" CssClass="table table-striped" BorderStyle="None" GridLines="Horizontal" BackColor="#E9BED3" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="5">
        <Columns>
            ...
            <asp:TemplateField HeaderText="ArtistId" SortExpression="ArtistId">
                ...
                <ItemTemplate>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource2" DataTextField="NameAndId" DataValueField="ArtistId" Enabled="false" Width="250px"
