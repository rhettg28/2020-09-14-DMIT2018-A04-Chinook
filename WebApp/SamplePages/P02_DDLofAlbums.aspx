...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>P02 Drop-Down-List of Albums</h1>

    <asp:Label ID="Label1" runat="server" Text="Select An Album"></asp:Label>

    <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="ObjectDataSource1" DataTextField="AlbumTitle" DataValueField="AlbumId" AppendDataBoundItems="True" Width="350px">
