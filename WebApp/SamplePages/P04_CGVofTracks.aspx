...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Custome GridView of Tracks</h1>
    <div class="row">
        <asp:Label ID="MessageLabel" runat="server" ForeColor="#33CC33"></asp:Label>
    </div>
    <div class="row">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1" AllowPaging="True" PagerSettings-Mode="NumericFirstLast" PageSize="5" 
            GridLines="Horizontal" CssClass="table table-striped" BackColor="#BFCDDD" BorderStyle="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
            <Columns>
