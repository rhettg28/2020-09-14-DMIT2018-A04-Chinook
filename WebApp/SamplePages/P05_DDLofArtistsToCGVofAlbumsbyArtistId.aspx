...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:Button ID="Button1" runat="server" Text="Button" BackColor="#BDBDDF" BorderStyle="None" />
    ...
    <br />
    <div class="row">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource2" AllowPaging="True" PageSize="5" CssClass="table table-striped" BackColor="#ECE8D9" 
            BorderStyle="None" GridLines="Horizontal" PagerSettings-Mode="NumericFirstLast" EmptyDataText="No Data Available">
            <Columns>
